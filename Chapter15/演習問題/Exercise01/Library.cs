    ...
    public static class Library {
        ...
        static Library() {
            ...
            Books = new List<Book> {
                ...
                new Book { Title = "まるわかりMicrosoft Office入門", CategoryId = 5, Price = 4800, PublishedYear = 2015 },
                new Book { Title = "Word・Excel実践テンプレート集", CategoryId = 5, Price = 2600, PublishedYear = 2016 },
                new Book { Title = "たのしく学ぶExcel初級編", CategoryId = 5, Price = 4800, PublishedYear = 2015 },
            };
        }
    }
}
